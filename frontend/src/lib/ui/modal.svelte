<script lang="ts">
    ...
    let {
        ...
        contentClass = "fixed top-1/2 left-1/2 z-50 w-full max-w-lg -translate-x-1/2 -translate-y-1/2 rounded-md border border-border bg-surface-alt/95 shadow-xl ring-1 ring-border/40",
        bodyClass = "",
        ...
        closeButtonClass = "text-muted-foreground hover:text-foreground",
        showClose = true,
